...
public class MagickImage extends Magick {
	 ...
	 *
	 * @param imageInfo the ImageInfo for an image file to read
	 * @throws MagickException on error on error
	 */
	 ...
	 * @throws MagickException on error
	 */
	public native Point getDimension()
			throws MagickException;
	 ...
	 * @see #getBorderColor
	 */
	public native MagickImage borderImage(Rect borderInfo)
			throws MagickException;
	 ...
	 * @throws MagickException on error
	 */
	public native boolean raiseImage(Rect raiseInfo, boolean raise)
			throws MagickException;
	 ...
	 * @throws MagickException on error
	 */
	public native MagickImage chopImage(Rect chopInfo)
			throws MagickException;
	 ...
	 * @throws MagickException on error
	 */
	public native MagickImage cropImage(Rect chopInfo)
			throws MagickException;
