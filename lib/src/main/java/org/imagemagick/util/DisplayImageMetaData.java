package org.imagemagick.util;

import java.lang.reflect.*;

import org.imagemagick.*;
...
public class DisplayImageMetaData {
    ...
    public static String colorspaceTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.ColorspaceType.class, value);
    }

    public static String classTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.ClassType.class, value);
    }

    public static String compositeOperatorAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.CompositeOperator.class, value);
    }

    public static String compressionTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.CompressionType.class, value);
    }

    public static String decorationTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.DecorationType.class, value);
    }

    public static String drawInfoAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.DrawInfo.class, value);
    }

    public static String exceptionTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.ExceptionType.class, value);
    }

    public static String filterTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.FilterType.class, value);
    }

    public static String geometryFlagsAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.GeometryFlags.class, value);
    }

    public static String gravityTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.GravityType.class, value);
    }

    public static String imageTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.ImageType.class, value);
    }

    public static String interlaceTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.InterlaceType.class, value);
    }

    public static String noiseTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.NoiseType.class, value);
    }

    public static String previewTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.PreviewType.class, value);
    }

    public static String primitiveTypeAsString(int value) {
        return nameAndValueOfpublicstaticintField(org.imagemagick.PrimitiveType.class, value);
    }
